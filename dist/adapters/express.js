...
function expressMiddleware(route) {
  return async function handler(req, res) {
    try {
      const raw = req.rawBody || req.body?.raw || void 0;
      ...
      const opts = { provider, headers, rawBody: raw, tolerance: route.tolerance, replayStore: route.replayStore };
